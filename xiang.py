...
def er_plot(stock):
    ...
    date_labels = [date.year for date in dates]
    ...
    for date in reversed(dates):
        #unit in billion
        revenues.append(round((stock.income_stmt[date]['Total Revenue']/unit),2))
        earnings.append(round((stock.income_stmt[date]['Net Income']/unit),2))
    ...
    if stock.info['shortName']:
        ...
        ax.set_title("Yearly Earnings vs Revenues")
